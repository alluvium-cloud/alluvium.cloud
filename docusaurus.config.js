...
const config = {
  title: 'Eric Reeves - DevOps, Platform & Cloud Engineer',
  tagline: 'I build computer stuff.',
  ...
  themeConfig:
    ...
    ({
      navbar: {
        title: 'Eric Reeves Brain Dump',
        logo: {
          alt: 'Eric Reeves Brain Dump',
          src: 'img/logo.svg',
        },
        items: [
          {
          ...
          {
            href: 'https://github.com/ericreeves/alluvium.cloud',
            label: 'GitHub',
            position: 'right',
          },
        ],
